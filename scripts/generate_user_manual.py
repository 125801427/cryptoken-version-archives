        ...
        [
            ...
            table(
                [
                    ...
                    ["付款地址", "<PAYER_WALLET_ADDRESS>"],
                    ["收款地址", "<RECEIVER_WALLET_ADDRESS>"],
                ],
                [42 * mm, 125 * mm],
            ),
...
"""
            ...
            bullets(
                [
                    ...
                    "收款地址只使用配置的 <RECEIVER_WALLET_ADDRESS>。",
            ...
            numbered(
                [
                    ...
                    "安装或打开 MetaMask 后, 切换到付款地址 <PAYER_WALLET_ADDRESS>。",
...
"""
            ...
            table(
                [
                    ...
                    ["CRYPTOKEN_PAYER_ADDRESS", "允许付款地址", "<PAYER_WALLET_ADDRESS>"],
                    ["CRYPTOKEN_RECEIVER_ADDRESS", "平台收款地址", "<RECEIVER_WALLET_ADDRESS>"],
                ],
                [55 * mm, 55 * mm, 58 * mm],
            ),
        ]
